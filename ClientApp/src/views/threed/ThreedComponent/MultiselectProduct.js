...
// export const MultiSelectProduct2 = (props) => { 

//     const [selectedprlist, setSelectedprlist] = useState([])

//     const prlist =  props.PrOrList
...
//         return () => {
//             setSelectedprlist([])
//             props.productsref.current = { value: [] }
//         }
//     }, [props.multiSlectReset])
...
//                     const productArray = e.value.map(item => item.name)

//                     props.productsref.current = {
//                         value: productArray.length === 0 ? [] : productArray
//                     }
//                 }}
//                 placeholder="Select"
//                 optionLabel="name"               
