...
const CloneOrganization = (props) => {
    ...
    const onSubmit = data => {
        ...
        // obj.products = productsref.current.value
        obj.max_users = 5
        obj.google_id = '0'
        obj.product_dobby = false
        obj.product_archive = true
        obj.product_collezioni = false
        obj.product_q3d = true
        obj.product_showroom = false
