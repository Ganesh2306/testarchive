...
//import { MultiSelectProduct2 } from '../../threed/ThreedComponent/MultiselectProduct'
...
const ModalBodyUI = (props) => {
    ...
    useEffect(async () => {
        ...
        //const productlist = await axios.get(`./ThreeD/GetProductList`)
        //setPrOrList(JSON.parse(productlist.data)) PrOrList.ProductList
        //setPrOrList((productlist && (productlist.data ? JSON.parse(productlist.data) : null)))
    ...
    return (
        ...
        <ModalBody>
            ...
            {/* <Col className="row form-group">
                <Label className="col-form-Label col-sm-12 col-md-4 col-lg-2 mt-1"> Products<span style={{ color: 'red' }}>*</span>
                </Label>
                <div className="col-sm-12 col-md-8 col-lg-4 p-0 mt-1">
                    {PrOrList && (<MultiSelectProduct2 PrOrList={PrOrList}  productsref={props.productsref}  panelClassName="force-downward"/>)}
                </div>
            </Col> */}
        </ModalBody >
    )
