...
namespace ARCHIVE_DASHBOARD.Controllers
{
    ...
    public class DesignController : Controller
    {
        ...
        //}
        public async Task<IActionResult> GetDesignMasterExcel([FromBody] GetDesignMasterExcelRequest r)
        {
            GetStorageLocation();
            ...
            var result1 = ApiHelper.GetDataNewQS(
                baseAddress,
                "api/Configuration/GetFolderIdByDesTypeIdDesSupId?DesignTypeId=" + r.designTypeId +
                "&DesignGroupId=" + r.designGroupId +
                "&OrgId=" + myComplexObject.OrganisationId +
                "&DesignSupplierId=" + myComplexObject.org_type_id,
                myComplexObject.AccessToken
            );
            ...
            var response = await ApiHelper.ExcelPostData(
                baseAddress,
                "api/Configuration/GetDesignMasterExcel",
                r,
                myComplexObject.AccessToken
            );
